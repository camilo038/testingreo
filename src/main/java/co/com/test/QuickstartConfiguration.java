...
public class QuickstartConfiguration {
    ...
    private String quickstart_codigo_Errorsql;
    
    
    
	
	public String getQuickstart_codigo_Errorsql() {
		return quickstart_codigo_Errorsql;
	}
	public void setQuickstart_codigo_Errorsql(String quickstart_codigo_Errorsql) {
		this.quickstart_codigo_Errorsql = quickstart_codigo_Errorsql;
	}
